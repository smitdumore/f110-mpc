...
public:
    ...
    static visualization_msgs::Marker GenerateList(std::vector<geometry_msgs::Point> &marker_points, std::vector<std_msgs::ColorRGBA> &marker_colors, int type = visualization_msgs::Marker::SPHERE_LIST,  double scale_x = 0.05, double scale_y = 0.05, double scale_z = 0.05);
    static visualization_msgs::Marker GenerateList(std::vector<std::pair<float,float>> &points, std::vector<std_msgs::ColorRGBA> &marker_colors, int type = visualization_msgs::Marker::SPHERE_LIST,  double scale_x = 0.05, double scale_y = 0.05, double scale_z = 0.05);
